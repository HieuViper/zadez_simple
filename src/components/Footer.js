        ...
        <div className="lg:w-1/3 p-6">
          <div className="text-sm">
            ...
            <p>
              ...
              hành. Quý khách hàng tại thị trường Việt Nam vui lòng kích hoạt và
              tra cứu bảo hành (miễn phí) tại website PSI.ZADEZ.VN. <br />
              ZADEZ - Make Life Easier
            </p>
          </div>
        </div>
        <div className="lg:w-1/3 p-6">
          <div className="text-white font-bold mb-7"></div>
          <div className="text-sm">
            <p>
              - Tổng đài CSKH: (028) 7777.0053 - 1900.0053 (phục vụ từ
              8h30-17h30, T2-T6)
              <br />- Kích Hoạt &amp; Tra Cứu Bảo Hành: website PSI.ZADEZ.VN
              <br />- Fanpage: Facebook.com/ZadezVietnam
              <br />- Messeger: M.me/ZadezVietnam
              <br />- Tài khoản Zalo Official Account:
              Zalo.me/3126944695787017498
              <br />- Trung tâm CSKH: B97 Phú Thuận, phường Phú Thuận, Quận 7,
              Tp. Hồ Chí Minh
            </p>
          </div>
        </div>
