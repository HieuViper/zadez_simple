...
export default function Home() {
  ...
  //
  const slideBanners = [
    { name: "Zadez", image: "/images/banner1200.jpg" },
    { name: "Zadez", image: "/images/banner1200.jpg" },
    { name: "Zadez", image: "/images/banner1200.jpg" },
  ];
  ...
  const initDataSlide = [
    {
      product_code: "999",
      main_image: "/images/ZADEZ-Gaming-Wireless-Mouse.webp",
      price: "999999",
      name: "Macbook Bro`",
      stock: 'in',
      short:
    ...
    {
      product_code: "999",
      main_image: "/images/ZADEZ-Headset-Stand.webp",
      price: "999999",
      name: "Macbook Bro`",
      stock: 'in',
      short:
  ...
  return (
    <main className="">
      ...
      <div id="outstanding-products" className="bg-gray-100 rounded-md p-4 mb-4 bg-[url('/images/bg-newyear.jpg')] bg-contain">
        ...
        <SlideCard data={initDataSlide} />
      </div>

      {/* SẢN PHẨM MỚI */}
      <div id="new-products" className="bg-gray-100 rounded-md p-4 mb-4 bg-[url('/images/bg-newyear2.jpg')] bg-contain">
        <h2 className="text-xl font-bold text-white">Sản phẩm mới</h2>
        <SlideCard data={initDataSlide} />
      </div>

      {/* TOP BÁN CHẠY */}
      <div id="best-seller" className="bg-gray-100 rounded-md p-4 mb-4 bg-[url('/images/bg-newyear3.jpg')] bg-contain">
        <h2 className="text-xl font-bold text-gray-700">Top bán chạy</h2>
        <SlideCard data={initDataSlide} />
      </div>

      {/* DANH MỤC SẢN PHẨM */}
      <section id="categories" className="py-10 bg-gray-100 rounded-md p-4 my-4">
        <h2 className="text-xl font-bold text-red-500">Danh mục sản phẩm</h2>
      ...
      {/* ZADEZ */}
      <div className="flex flex-col justify-center items-center text-center h-[600px] bg-[url('/images/banner-zadez.jpg')] bg-cover">
        <div className="w-1/2 ">
          <h2 className="text-2xl text-red-500">ZADEZ GAMING</h2>
