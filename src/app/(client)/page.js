...
export default function Home() {
  ...
  const { data: newPoducts } = useSWRData(`/api/products?status=new`);
  ...
  return (
    <main className="w-full bg-[#f8f9fa]">
      ...
      <div
        ...
        className="bg-gray-100 rounded-md p-4 mb-4 bg-[url('/images/bg-newyear.jpg')] bg-contain"
      >
      ...
      <div
        id="new-products"
        className="bg-gray-100 rounded-md p-4 mb-4 bg-[url('/images/bg-newyear2.jpg')] bg-contain"
      >
      ...
      <div
        id="best-seller"
        className="bg-gray-100 rounded-md p-4 mb-4 bg-[url('/images/bg-newyear3.jpg')] bg-contain"
      >
