    ...
    <div>
      <section id="section1" className="grid grid-cols-2 gap-4 pb-64">
        <div className="col-span-2 md:col-span-1 p-20">
          <p className="text-xl font-[500]">ZADEZ NEW PRODUCT</p>
        ...
        <div className="col-span-2 md:col-span-1">
          <Image
            width={400}
            height={400}
            src="/images/landing-page/gp-803/img1.png"
            alt="GP-803"
            sizes="100vw"
            style={{
              marginTop: "20px",
      ...
      <section
        id="section3"
        className="grid grid-cols-2 gap-8 pt-64 pb-32 bg-[url('/images/landing-page/gp-803/bg1.png')] bg-center lg:-ml-16 lg:-mr-16 xl:-ml-24 xl:-mr-24"
      >
        <div className="col-span-2 md:col-span-1">
          <Image
            width={200}
        ...
        <div className="col-span-2 md:col-span-1 text-right pr-10">
          <h2 className="text-6xl font-bold uppercase text-yellow-400 ">
            ENC-KHỬ ỒN CAO CẤP
          </h2>
          ...
          <div className="flex justify-end ">
            <button
              className="bg-yellow-300 w-40 p-4 flex justify-center items-center cursor-pointer"
              onClick={showModal}
            >
      ...
      <section
        id="section4"
        className="col-span-2 md:col-span-1 grid grid-cols-2 p-20 gap-2"
      >
        <Image
          className="col-span-2 md:col-span-1"
          width={300}
          height={300}
          src="/images/landing-page/gp-803/img3.png"
          alt="GP-803"
          sizes="100vw"
          style={{
            width: "100%",
      ...
      <section
        id="section 5"
        className="bg-[url('/images/landing-page/gp-803/bg2.png')] bg-center py-20 lg:-ml-16 lg:-mr-16 xl:-ml-24 xl:-mr-24"
      >
            ...
            items={[
              {
                ...
                children: (
                  <div className=" bg-white px-10 rounded-lg m-auto">
      ...
      <section
        id="params"
        className="bg-[url('/images/landing-page/gp-803/bg3.png')] bg-center py-40 lg:-ml-16 lg:-mr-16 xl:-ml-24 xl:-mr-24 "
      >
      ...
      <section
        id="form"
        className="grid grid-cols-2 py-20  bg-yellow-300 px-6 lg:px-16 xl:px-24 lg:-ml-16 lg:-mr-16 xl:-ml-24 xl:-mr-24"
      >
        <div className="col-span-2 md:col-span-1">
        ...
        <div className="col-span-2 md:col-span-1 grid grid-cols-2">
          <Image
            ...
            width={300}
            height={300}
            src="/images/landing-page/gp-803/GP-803BW/GP-803GW-1.png"
            alt="GP-803GW"
            sizes="100vw"
            style={{
              width: "100%",
          ...
          <Image
            ...
            width={300}
            height={300}
            src="/images/landing-page/gp-803/GP_803B/GP-803B-3.png"
            alt="GP-803B"
            sizes="100vw"
            style={{
              width: "100%",
      ...
      <section
        id="contact"
        className="py-10 flex flex-col justify-center items-center text-center"
      >
        <iframe
          ...
          <div className="flex gap-10 pb-8">
            ...
            >
              <Image
                ...
                width={50}
                height={50}
                src="/images/icon-logo/facebook.png"
                alt="facebook"
              />
            </Link>
            <Link
            ...
            >
              <Image
                ...
                width={50}
                height={50}
                src="/images/icon-logo/instagram.png"
                alt="instagram"
              />
            </Link>
            <Link href="https://www.youtube.com/zadezvietnam" target="_blank">
              <Image
                ...
                width={50}
                height={50}
                src="/images/icon-logo/youtube.png"
                alt="youtube"
              />
            </Link>
            <Link href="" target="_blank">
              <Image
                ...
                width={50}
                height={50}
                src="/images/icon-logo/tik-tok.png"
                alt="tiktok"
              />
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div
            className={`flex flex-col justify-center items-center cursor-pointer rounded-lg border  hover:border-solid hover:border-cyan-500 ${
              activeCard === 1
                ? "border border-transparent border-solid border-cyan-500 duration-100 rounded-lg shadow-xl"
                : ""
            }`}
            onClick={() => {
              setActiveCard(1);
