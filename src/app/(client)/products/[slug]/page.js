...
const Product = ({ params }) => {
  ...
  const product = {
    ...
    product_code: "803",
    main_image:
      "https://zadez.vn/wp-content/uploads/2023/08/GP-803B-Black_Square_1-1024x1024.webp",
    sub_image:
      "https://zadez.vn/wp-content/uploads/2023/08/GP-803B-White_Square_1-1024x1024.webp",
    categories: "1",
    price: 850000,
    ...
    <div className="px-4 md:px-20 ">
      <div className="grid grid-cols-5 gap-5">
        ...
        <div className="col-span-5 md:col-span-2">
          ...
          <div className="pb-4">{product_langs.short}</div>
          <div className="pb-2">
            {product.stock == "in" ? (
      ...
      <div>{product_langs.short}</div>
      <div className="flex justify-center items-center">
        <div dangerouslySetInnerHTML={{ __html: product_langs.description }} />
      </div>
      {/* SIMILAR PRODUCT */}
